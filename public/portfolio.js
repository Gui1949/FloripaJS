...
class Portfolio extends Floripa {
  ...
  render = () => {
    init();
    createUpperNavBar("Meu Portfólio"), initDiv("master");
    initDiv("feedUpperMargin"),
      createCard(
        "card1",
        "https://avatars.githubusercontent.com/u/28566734?v=4",
        "Guilherme Floriano",
        " Engenheiro de Software | Rest API | React | Java | ERP Sankhya",
